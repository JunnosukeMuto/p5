...
void draw() {
  ...
  drawClock(height*0.15, new PVector(width/2-100, height/2-75), h-9, m, s);  // 世界協定時UTC (-9時間）
  drawClock(height*0.1, new PVector(width/2+100, height/2-75), h-13, m, s);  // ワシントン（-13時間）
